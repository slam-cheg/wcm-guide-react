                ...
                <div className="section__content">
                    ...
                    <ol className="section__list">
                        ...
                        <li className="section__list-item">
                            ...
                            &nbsp;&mdash; откроется дополнительное меню с&nbsp;5&nbsp;видами представления данных и&nbsp;дополнительными настройками;
                        </li>
                        <li className="section__list-item">
                            В&nbsp;строке меню <RedWords prop={"«Frequency»"} /> в&nbsp;первом окошке установить <RedWords prop={"«Impressions»"} />{" "}
