        ...
        <div className="section__wrapper">
            <section className="section section__not-homepage" id="settings">
                ...
                <div className="section__content">
                    ...
                    <br />
                    <p className="section__lead">
                        В&nbsp;блоке <RedWords prop={"«Selected Metrics»"} /> отображаются выбранные показатели из&nbsp;левого меню. Их&nbsp;легко удалить
                        из&nbsp;списка выбранных, нажав на&nbsp;значок корзины справа от&nbsp;ранее выбранной метрики.
                    </p>
                </div>
