...
export class Automatization extends React.Component {
    render() {
        return (
            <div className="section__wrapper">
                <section className="section section__not-homepage" id="automatization">
                    ...
                    <div className="section__content">
                        <p className="section__lead">
                            В&nbsp;форме <RedWords prop={"«Preview of final Report»"} /> можно проверить структуру собранного отчета согласно
                            настроенным параметрам в&nbsp;форме <RedWords prop={"«Report Content»"} />. Для завершения настройки необходимо кликнуть{" "}
