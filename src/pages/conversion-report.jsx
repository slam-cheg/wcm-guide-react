...
const redWords = {
    text: "IM\u00A0(image), IM-SSL (image с\u00A0защищенным протоколом), тоже самое для\u00A0JS (JavaScript) и\u00A0JS-SSL (JavaScript с\u00A0защищенным протоколом). В\u00A0данный момент по\u00A0умолчанию мы\u00A0используем только IM-SSL.",
};
