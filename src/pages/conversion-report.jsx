            ...
            <section className="section section__not-homepage" id="conversion-report">
                ...
                <div className="section__grid-block">
                    <div className="section__content">
                        <p className="section__lead" style={style}>
                            При переходе на&nbsp;вкладку Conversion в&nbsp;верхнем меню в&nbsp;интерфейсе WCM появляется список конверсионных тегов,
                            сгенерированных в&nbsp;рамках аккаунта. Верхняя строка меню в&nbsp;списке конверсионных тегов показывает количество
                            конверсий в&nbsp;столбце &laquo;#Conv.&raquo; за&nbsp;указанный период в&nbsp;правом верхнем углу и&nbsp;распределение
                            типа подготовленного тега на&nbsp;формат:
                            <br />
                            <br />
                            <span className="section__lead section__lead_color" style={styles}>
                                IM&nbsp;(image), IM-SSL (image с&nbsp;защищенным протоколом), тоже самое для&nbsp;JS (JavaScript) и&nbsp;JS-SSL
                                (JavaScript с&nbsp;защищенным протоколом). В&nbsp;данный момент по&nbsp;умолчанию мы&nbsp;используем только IM-SSL.
                            </span>
                        </p>
                    </div>
                ...
                <div className="section__grid-block">
                    ...
                    <div className="section__content">
                        <p className="section__lead">
                            ...
                            в&nbsp;раздел Reporting по&nbsp;РК. В&nbsp;меню Select Metrics в&nbsp;разделе Basic выбрать метрику
