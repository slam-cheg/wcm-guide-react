...
export class ConversionTags extends React.Component {
    render() {
        return (
                ...
                <section className="section section__not-homepage" id="conversion-report">
                    ...
                    <div className="section__content">
                        ...
                        <ol className="section__list">
                            ...
                            <li className="section__list-item">
                                В&nbsp;разделе <RedWords prop={"«Basic»"} /> выбрать метрику <RedWords prop={"«Conversions»"} /> и&nbsp;необходимы
                                набор дополнительных метрик в&nbsp;разделе <RedWords prop={"«Performance»"} />;
                            </li>
                            <li className="section__list-item">
