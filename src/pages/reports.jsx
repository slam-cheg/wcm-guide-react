                    ...
                    <div className="section__grid-block">
                        <div className="section__content" style={{ justifyContent: "center" }}>
                            <p className="section__lead">
                                ...
                                &nbsp;&mdash; вкладка со&nbsp;статистикой по&nbsp;размещению и&nbsp;всеми отчетами По&nbsp;умолчанию тут представлены
                                все проекты, заведенные внутри аккаунта (список проектов в&nbsp;таблице под графиком).
                                <br /> Можно зайти внутрь проекта, кликнув по&nbsp;нему.
                            </p>
                        </div>
                    ...
                    <div className="section__grid-block section__grid-block_reverse">
                        ...
                        <div className="section__content" style={{ justifyContent: "center" }}>
                            <p className="section__lead">
                                ...
                                <Link prop={{ text: "«Campaigns»", href: "/campaigns" }} />, чтобы увидеть список кампаний. Можно зайти внутрь
                                кампании, кликнув по&nbsp;ней.
                            </p>
                        </div>
                    </div>
                </section>
